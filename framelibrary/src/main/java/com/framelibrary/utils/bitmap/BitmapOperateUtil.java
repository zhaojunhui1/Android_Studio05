 ...
 */
package com.framelibrary.utils.bitmap;
...
import com.framelibrary.utils.M2DeviceUtils;
import com.framelibrary.utils.M2FileUtils;
...
public class BitmapOperateUtil {
    ...
    public static void correctPictureAngle(String path) {
        ...
        if (angle != 0) {
            ...
            M2FileUtils.saveBitmapToFile(image, path);
        }
    }
    ...
    public static void SetMistyBitmap(View imageview, Bitmap src) {
        if (imageview == null || src == null)
            return;
        if (M2DeviceUtils.getSDKVersion() >= 18) {
            ...
            if (imageview instanceof ImageView) {
                ...
                imageview.setBackgroundDrawable(new BitmapDrawable(imageview.getResources(), blur(src, 12)));
            }
        }
    }
    ...
    private static Bitmap blur(Bitmap bkg, View imageView, float radius) {
        ...
        if (imageView instanceof ImageView) {
            ...
            imageView.setBackground(new BitmapDrawable(imageView.getResources(), overlay));
        }
        rs.destroy();
        return overlay;
    }
